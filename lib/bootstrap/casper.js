...
function getCreateFn(server) {
    ...
    return function create (options) {
        ...
        instance.getData = function getData(fn, eventName) {
            if (typeof fn === 'function' && typeof eventName === 'string') {
                instance.then(function() {
                    var base64 = this.evaluate(function(dataToEncode) {
                        return __utils__.encode(dataToEncode);
                    }, fn.call(this));
                    this.emit(eventName, base64);
                });
            } else {
                throw 'Incorrect type of arguments in getData method';
            }
        };
